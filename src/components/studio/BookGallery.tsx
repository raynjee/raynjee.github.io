...
// Stat line below the cover shows progress %, chapter count, and a reading
// time estimate (computed from total words) so the user can see "how far"
// and "how long" at a glance without opening the book.
      ...
      >
        ...
        <div className="mt-2.5 px-0.5">
          <div className="text-[11px] text-muted-foreground truncate">
            {pct}% · {totalChapters} ch · {formatReadingTime(totalWords)}
          </div>
