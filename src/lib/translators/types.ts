...
function loadProviderStatus(): ProviderStatus[] {
  ...
  try {
    return (window as unknown as { __raynetsProviderStatus?: ProviderStatus[] })
      .__raynetsProviderStatus ?? [];
  } catch {
    return [];
  }
}
...
async function saveProviderStatus(s: ProviderStatus[]) {
  if (typeof window === "undefined") return;
  (window as unknown as { __raynetsProviderStatus?: ProviderStatus[] }).__raynetsProviderStatus = s;
  try {
