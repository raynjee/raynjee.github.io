...
//
// The Gist contains a single file "raynets-backup.json". Its content is:
...
const GIST_FILENAME = "raynets-backup.json";
const DESCRIPTION_PREFIX = "raynets-sync-";
...
async function createSyncGist(
  ...
  try {
    ...
    const res = await fetch(GIST_API, {
      ...
      body: JSON.stringify({
        description: `${marker} — RaynETS backup (encrypted)`,
        public: false,
